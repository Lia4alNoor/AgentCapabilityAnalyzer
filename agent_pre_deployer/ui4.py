...
if st.session_state.show_curation:

    active_tab = None

    if st.button("← Back to Analysis", key="curation_back"):
        st.session_state.show_curation = False
        st.rerun()

else:

    nav_col, action_col = st.columns([5, 1.6])
    ...
    with action_col:
        if st.button(
            ...
            st.session_state.show_curation = True
            st.rerun()
...
# =========================================================
# THREAT CHAIN CURATION — MODULE 10
# =========================================================
